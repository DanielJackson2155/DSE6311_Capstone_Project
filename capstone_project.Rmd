...
For our final model, we will fit a Suppor Vector Machine model. We want to try and fit a similar performing model that may be more interpretable than our neural network model. Even if we produce similar results, if we can convey the process and identify variables with more predictive power to our stakeholders, it will be much more easier to implement our policies to help students who suffer from COVID-19 anxiety.
